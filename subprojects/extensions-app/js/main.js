...
const GnomeShellIface = loadInterfaceXML('io.github.scarecrow-de.Shell.Extensions');
...
function loadInterfaceXML(iface) {
    const uri = 'resource:///io/github/scarecrow-de/Extensions/dbus-interfaces/%s.xml'.format(iface);
...
class Application extends Gtk.Application {
    _init() {
        ...
        super._init({ application_id: 'io.github.scarecrow-de.Extensions' });
    }
    ...
    vfunc_startup() {
        ...
        let uri = 'resource:///io/github/scarecrow-de/Extensions/css/application.css';
        try {
        ...
        this._shellProxy = new GnomeShellProxy(Gio.DBus.session,
            'io.github.scarecrow-de.Shell.Extensions', '/io/github/scarecrow-de/Shell/Extensions');
...
var ExtensionsWindow = GObject.registerClass({
    ...
    Template: 'resource:///io/github/scarecrow-de/Extensions/ui/extensions-window.ui',
    InternalChildren: [
        'userList',
        'systemList',
        'mainBox',
    ...
    _showAbout() {
        let aboutDialog = new Gtk.AboutDialog({
            ...
            logo_icon_name: 'io.github.scarecrow-de.Extensions',
...
var ExtensionRow = GObject.registerClass({
    ...
    Template: 'resource:///io/github/scarecrow-de/Extensions/ui/extension-row.ui',
    InternalChildren: [
        'nameLabel',
        'descriptionLabel',
        'versionLabel',
