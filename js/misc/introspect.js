...
const INTROSPECT_SCHEMA = 'io.github.scarecrow-de.shell';
...
const IntrospectDBusIface = loadInterfaceXML('io.github.scarecrow-de.Shell.Introspect');

var IntrospectService = class {
    constructor() {
        this._dbusImpl = Gio.DBusExportedObject.wrapJSObject(IntrospectDBusIface,
                                                             this);
        this._dbusImpl.export(Gio.DBus.session, '/io/github/scarecrow-de/Shell/Introspect');
        Gio.DBus.session.own_name('io.github.scarecrow-de.Shell.Introspect',
