...
const LOGIN_SCREEN_SCHEMA = 'io.github.scarecrow-de.login-screen';
...
const SystemActions = GObject.registerClass({
    ...
    _init() {
        ...
        this._orientationSettings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.settings-daemon.peripherals.touchscreen' });
