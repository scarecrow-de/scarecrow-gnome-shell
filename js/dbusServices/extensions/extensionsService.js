...
const ExtensionsIface = loadInterfaceXML('io.github.scarecrow-de.Shell.Extensions');
...
var ExtensionsService = class extends ServiceImplementation {
    constructor() {
        super(ExtensionsIface, '/io/github/scarecrow-de/Shell/Extensions');

        this._proxy = new ExtensionsProxy(Gio.DBus.session,
            'io.github.scarecrow-de.Shell', '/io/github/scarecrow-de/Shell');
...
var ExtensionPrefsDialog = GObject.registerClass({
    ...
    Template: 'resource:///io/github/scarecrow-de/Shell/Extensions/ui/extension-prefs-dialog.ui',
    InternalChildren: [
        'headerBar',
        'stack',
        'expander',
    ...
    _addCustomStylesheet() {
        ...
        let uri = 'resource:///io/github/scarecrow-de/Shell/Extensions/css/application.css';
        try {
