...
function installExtension(uuid, invocation) {
    ...
    _httpSession.queue_message(message, () => {
        if (message.status_code != Soup.KnownStatusCode.OK) {
            ...
            invocation.return_dbus_error('io.github.scarecrow_de.Shell.DownloadInfoError', message.status_code.toString());
            return;
        }
        ...
        try {
            ...
            invocation.return_dbus_error('io.github.scarecrow_de.Shell.ParseInfoError', e.toString());
            return;
        }
...
class InstallExtensionDialog extends ModalDialog.ModalDialog {
    ...
    _onInstallButtonPressed() {
        ...
        function errback(code, msg) {
            ...
            invocation.return_dbus_error('io.github.scarecrow_de.Shell.%s'.format(code), msg || '');
        }
