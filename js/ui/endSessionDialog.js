...
const EndSessionDialogIface = loadInterfaceXML('io.github.scarecrow-de.SessionManager.EndSessionDialog');
...
class EndSessionDialog extends ModalDialog.ModalDialog {
    _init() {
        ...
        this._dbusImpl.export(Gio.DBus.session, '/io/github/scarecrow-de/SessionManager/EndSessionDialog');
    }
    ...
    async OpenAsync(parameters, invocation) {
        ...
        if (!(this._type in DialogContent)) {
            invocation.return_dbus_error('io.github.scarecrow-de.Shell.ModalDialog.TypeError',
        ...
        if (!this.open(timestamp)) {
            invocation.return_dbus_error('io.github.scarecrow-de.Shell.ModalDialog.GrabError',
