...
const PortalHelperIface = loadInterfaceXML('io.github.scarecrow-de.Shell.PortalHelper');
...
function launchSettingsPanel(panel, ...args) {
    ...
    try {
        Gio.DBus.session.call(
            'io.github.scarecrow-de.ControlCenter',
            '/io/github/scarecrow-de/ControlCenter',
...
class Indicator extends PanelMenu.SystemIndicator {
    ...
    _syncConnectivity() {
        ...
        if (this._portalHelperProxy) {
            ...
            new PortalHelperProxy(Gio.DBus.session, 'io.github.scarecrow-de.Shell.PortalHelper',
                                  '/io/github/scarecrow-de/Shell/PortalHelper', (proxy, error) => {
                                      if (error) {
