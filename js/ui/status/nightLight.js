...
const BUS_NAME = 'io.github.scarecrow-de.SettingsDaemon.Color';
const OBJECT_PATH = '/io/github/scarecrow-de/SettingsDaemon/Color';

const ColorInterface = loadInterfaceXML('io.github.scarecrow-de.SettingsDaemon.Color');
...
class Indicator extends PanelMenu.SystemIndicator {
    _init() {
        ...
        this._item.menu.addAction(_("Turn Off"), () => {
            let settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.settings-daemon.plugins.color' });
