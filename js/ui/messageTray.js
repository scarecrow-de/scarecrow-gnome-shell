...
const SHELL_KEYBINDINGS_SCHEMA = 'io.github.scarecrow-de.shell.keybindings';
...
var NotificationGenericPolicy = GObject.registerClass({
    ...
    _init() {
        ...
        this._masterSettings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.desktop.notifications' });
...
var NotificationApplicationPolicy = GObject.registerClass({
    ...
    _init(id) {
        ...
        this._settings = new Gio.Settings({
            schema_id: 'io.github.scarecrow-de.desktop.notifications.application',
            path: '/io/github/scarecrow-de/desktop/notifications/application/%s/'.format(this._canonicalId),
        });
