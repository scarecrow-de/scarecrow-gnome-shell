...
const CalendarServerIface = loadInterfaceXML('io.github.scarecrow-de.Shell.CalendarServer');
...
function CalendarServer() {
    return new Gio.DBusProxy({ g_connection: Gio.DBus.session,
                               ...
                               g_name: 'io.github.scarecrow-de.Shell.CalendarServer',
                               g_object_path: '/io/github/scarecrow-de/Shell/CalendarServer' });
}
...
var Calendar = GObject.registerClass({
    ...
    _init() {
        ...
        this._settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.desktop.calendar' });
...
class Placeholder extends St.BoxLayout {
    _init() {
        ...
        const file = Gio.File.new_for_uri(
            'resource:///io/github/scarecrow-de/shell/theme/no-notifications.svg');
...
class DoNotDisturbSwitch extends PopupMenu.Switch {
    _init() {
        this._settings = new Gio.Settings({
            schema_id: 'io.github.scarecrow-de.desktop.notifications',
        });
