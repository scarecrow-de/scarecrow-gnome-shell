...
var ShellMountPasswordDialog = GObject.registerClass({
    ...
    _init(message, flags) {
        ...
        let disksApp = Shell.AppSystem.get_default().lookup_app('io.github.scarecrow_de.DiskUtility.desktop');
    ...
    _onOpenDisksButton() {
        let app = Shell.AppSystem.get_default().lookup_app('io.github.scarecrow_de.DiskUtility.desktop');
        if (app) {
            app.activate();
        } else {
            Main.notifyError(
