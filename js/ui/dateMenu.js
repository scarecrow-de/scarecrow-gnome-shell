...
const ClocksIntegrationIface = loadInterfaceXML('io.github.scarecrow-de.Shell.ClocksIntegration');
...
class EventsSection extends St.Button {
    ...
    vfunc_clicked() {
        ...
        if (appInfo.get_id() === 'io.github.scarecrow-de.Evolution.desktop') {
...
class WorldClocksSection extends St.Button {
    _init() {
        ...
        this._settings = new Gio.Settings({
            schema_id: 'io.github.scarecrow-de.shell.world-clocks',
        });
    ...
    _sync() {
        this._clocksApp = this._appSystem.lookup_app('io.github.scarecrow-de.clocks.desktop');
