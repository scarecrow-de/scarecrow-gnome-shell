...
var KeyboardModel = class {
    ...
    _loadModel(groupName) {
        let file = Gio.File.new_for_uri('resource:///io/github/scarecrow_de/Shell/osk-layouts/%s.json'.format(groupName));
...
var EmojiSelection = GObject.registerClass({
    ...
    _populateSections() {
        let file = Gio.File.new_for_uri('resource:///io/github/scarecrow_de/Shell/osk-layouts/emoji.json');
        let [success_, contents] = file.load_contents(null);
