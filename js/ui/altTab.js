...
class GroupCyclerPopup extends CyclerPopup {
    _init() {
        this._settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.shell.app-switcher' });
        super._init();
    }
...
class WindowSwitcherPopup extends SwitcherPopup.SwitcherPopup {
    _init() {
        super._init();
        this._settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.shell.window-switcher' });
...
class AppSwitcher extends SwitcherPopup.SwitcherList {
    _init(apps, altTabPopup) {
        ...
        let settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.shell.app-switcher' });
