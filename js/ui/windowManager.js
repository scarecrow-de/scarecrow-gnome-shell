...
var SHELL_KEYBINDINGS_SCHEMA = 'io.github.scarecrow_de.shell.keybindings';
...
const GSD_WACOM_BUS_NAME = 'io.github.scarecrow_de.SettingsDaemon.Wacom';
const GSD_WACOM_OBJECT_PATH = '/io/github/scarecrow_de/SettingsDaemon/Wacom';

const GsdWacomIface = loadInterfaceXML('io.github.scarecrow_de.SettingsDaemon.Wacom');
...
var WindowManager = class {
    constructor() {
        ...
        this._scsdWacomProxy = new GsdWacomProxy(Gio.DBus.session, GSD_WACOM_BUS_NAME,
        ...
        global.display.connect('pad-mode-switch', (display, pad, group, mode) => {
            ...
            if (this._scsdWacomProxy) {
                this._scsdWacomProxy.SetOLEDLabelsRemote(pad.get_device_node(), labels);
                this._scsdWacomProxy.SetGroupModeLEDRemote(pad.get_device_node(), group, mode);
            }
        });
