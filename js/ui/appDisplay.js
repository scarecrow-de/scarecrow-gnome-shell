...
class AppDisplay extends BaseAppView {
    _init() {
        ...
        this._folderSettings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.desktop.app-folders' });
    ...
    createFolder(apps) {
        ...
        let newFolderSettings = new Gio.Settings({
            schema_id: 'io.github.scarecrow-de.desktop.app-folders.folder',
            path: newFolderPath,
        });
...
class FolderView extends BaseAppView {
    ...
    removeApp(app) {
        ...
        if (folderApps.length == 0) {
            ...
            let settings = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.desktop.app-folders' });
...
var FolderIcon = GObject.registerClass({
    ...
    _init(id, path, parentView) {
        ...
        this._folder = new Gio.Settings({ schema_id: 'io.github.scarecrow-de.desktop.app-folders.folder',
                                          path });
...
var AppIconMenu = class AppIconMenu extends PopupMenu.PopupMenu {
    ...
    _rebuildMenu() {
        ...
        if (!this._source.app.is_window_backed()) {
            ...
            if (Shell.AppSystem.get_default().lookup_app('io.github.scarecrow-de.Software.desktop')) {
                this._appendSeparator();
